  ...
  return (
    <>
      ...
      >
        ...
        {/* Update below buttons */}
        <div className="flex flex-col gap-2">
          <Link href={"/login"} className="flex items-center justify-center gap-4 px-4 py-3 border rounded-md bg-lightColor-800 dark:bg-darkColor-300 border-border-100 ">
            <button >
              Log In
            </button>
          </Link>
          <Link href={"/signup"} className="flex items-center justify-center gap-4 px-4 py-3 rounded-md dark:bg-darkColor-400 bg-lightColor-600 ">
            <button>
              Sign Up
            </button>
          </Link>
